...
end        elseif MyLevel == 100 or MyLevel <= 119 then
            Mon = "Snowman"
            LevelQuest = 2
            NameQuest = "SnowQuest"
            NameMon = "Snowman"
...
end        elseif MyLevel == 300 or MyLevel <= 324 then
...
end        elseif MyLevel == 775 or MyLevel <= 799 then
            Mon = "Swan Pirate"
            LevelQuest = 1
...
end        elseif MyLevel == 1125 or MyLevel <= 1174 then
            Mon = "Horned Warrior"
            LevelQuest = 2
            NameQuest = "IceSideQuest"
...
end        elseif MyLevel == 1525 or MyLevel <= 1574 then
...
end        elseif MyLevel == 1775 or MyLevel <= 1799 then
            Mon = "Fishman Raider"
            LevelQuest = 1
...
end        elseif MyLevel == 2100 or MyLevel <= 2124 then
...
function TweenTempleLegit()
	...
	end)    local Client = game.Players.LocalPlayer
...
local locallv = W:AddLabel("Level")
    ...
    local PointsStast = W:AddLabel("")    local Section = W:AddSection({
        Name = "Melee Check"
    })
...
end)local Section = M:AddSection({
    Name = "Select Weapon"
})
...
R:AddButton({
  ...
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
  wait(.1)
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.624694824218spawn(function()
    while wait() do
        if _G.AutoFarm then
            pcall(function()
...
-- Nota: O restante do script contém muitos loops de farm para itens específicos (Bone, Elite, Dough King, etc.) que são muito longos para incluir aqui, mas seguem o mesmo padrão.
